...
const Cardsection = () => {
    ...
    return (
        <div className='sm:pb-[100px] pb-[80px] pt-[40px] bgflorean'>
            <Container>
                {/* Top grid */}
                <div className='grid md:grid-cols-2 grid-cols-1 md:gap-[40px] gap-[24px]'>
                    {TopCards.map((item, index) => {
                        return (
                            <div onClick={() => handleCardClick(item.id)} className='shadow-box hover-shadow-green justify-between border cursor-pointer border-[#ECF1EE] rounded-[40px] xl:p-6  p-3 overflow-hidden  flex flex-col  bgwhite transition-all duration-250 ease-in-out' key={index}>
                ...
                <div className='grid md:grid-cols-2 grid-cols-1 md:gap-[40px] gap-[24px] mt-[40px]'>
                    {DownCards.map((item) => (
                        <div
                            ...
                            className='shadow-box cursor-pointer hover-shadow-green border border-[#ECF1EE] justify-between rounded-[40px] xl:p-6 p-3 overflow-hidden flex flex-col bgwhite transition-all duration-250 ease-in-out'
                        >
                            <img data-aos="fade-up"
                                src={item.image}
                                alt={item.key}
